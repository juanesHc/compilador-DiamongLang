...
from arbol        import NodoArbol, propagar_posicion_terminales
from errores      import ErrorSintactico, formatear_error
from sugerencias  import sugerencia_local
...
class ParserRecursivo:
    ...
    def _cargar_siguiente(cls):
        if cls._SIGUIENTE_CACHE is None:
            from tabla_ll import generar_tabla
