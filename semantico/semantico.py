...
from semantico.tabla_simbolos import (
    TablaSimbolos, Simbolo,
    como_dict as simbolo_a_dict,
)
from semantico.errores_semanticos import ErrorSemantico, como_dict as error_a_dict
from semantico.sugerencias_semanticas import sugerir as _sugerir_local
from semantico.tipos import (
    tipo_declarado,
